...
class HomogenDecoder(nn.Module):
    def __init__(
        self,
        latent_size,
        dims,
        ...
        super(HomogenDecoder, self).__init__()
        ...
        self.regressor = nn.Sequential(
            nn.Linear(latent_size, reg_hidden_size),
            nn.ReLU(),
            nn.Linear(reg_hidden_size, reg_hidden_size),
            nn.ReLU(),
            nn.Linear(reg_hidden_size, reg_hidden_size),
            nn.ReLU(),
            nn.Linear(reg_hidden_size, reg_hidden_size),
            nn.ReLU(),
            nn.Linear(reg_hidden_size, 3),
        )
